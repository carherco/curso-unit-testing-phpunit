...
class DNITest extends TestCase {
  public function testCalcularDNI(){
    $myClass = new DNI();
    $input = 15454424;
  ...
  public function testCalcularDNI2(){
    $myClass = new DNI();
    $input = 24391544;
    $output = $myClass->calcularLetra($input);
  ...
  public function testCalcularDNI3(){
    $myClass = new DNI();
    $input = 70878790;
    $output = $myClass->calcularLetra($input);
   ...
   */
  public function testCalcularDNIWithProvider($dni, $expectedOtuput){
    $myClass = new DNI();
